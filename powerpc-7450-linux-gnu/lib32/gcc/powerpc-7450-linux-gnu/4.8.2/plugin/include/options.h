...
#define OPTION_MASK_DLMZB (HOST_WIDE_INT_1 << 4)
#define OPTION_MASK_EABI (HOST_WIDE_INT_1 << 5)
#define OPTION_MASK_FPRND (HOST_WIDE_INT_1 << 6)
#define OPTION_MASK_DFP (HOST_WIDE_INT_1 << 7)
#define OPTION_MASK_SOFT_FLOAT (HOST_WIDE_INT_1 << 8)
#define OPTION_MASK_ISEL (HOST_WIDE_INT_1 << 9)
#define OPTION_MASK_MFCRF (HOST_WIDE_INT_1 << 10)
#define OPTION_MASK_MFPGPR (HOST_WIDE_INT_1 << 11)
#define OPTION_MASK_MINIMAL_TOC (HOST_WIDE_INT_1 << 12)
#define OPTION_MASK_MULHW (HOST_WIDE_INT_1 << 13)
#define OPTION_MASK_MULTIPLE (HOST_WIDE_INT_1 << 14)
#define OPTION_MASK_NO_UPDATE (HOST_WIDE_INT_1 << 15)
#define OPTION_MASK_POPCNTB (HOST_WIDE_INT_1 << 16)
#define OPTION_MASK_POPCNTD (HOST_WIDE_INT_1 << 17)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1 << 18)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1 << 19)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1 << 20)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1 << 21)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1 << 22)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1 << 23)
#define OPTION_MASK_STRING (HOST_WIDE_INT_1 << 24)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1 << 25)
 #if defined(HOST_BITS_PER_WIDE_INT) && 26 >= HOST_BITS_PER_WIDE_INT
...
enum opt_code
{
  ...
  OPT_m32 = 1038,                            /* -m32 */
  OPT_m64 = 1039,                            /* -m64 */
  OPT_mabi_altivec = 1040,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1041,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1042,                       /* -mabi=d64 */
  OPT_mabi_ibmlongdouble = 1043,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1044,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1045,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1046,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1047,                       /* -mabi=spe */
  OPT_mads = 1048,                           /* -mads */
  OPT_maix_struct_return = 1049,             /* -maix-struct-return */
  OPT_malign_ = 1050,                        /* -malign- */
  OPT_malign_branch_targets = 1051,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1052,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1053,             /* -mallow-movmisalign */
  OPT_maltivec = 1054,                       /* -maltivec */
  OPT_malways_hint = 1055,                   /* -malways-hint */
  OPT_mandroid = 1056,                       /* -mandroid */
  OPT_mavoid_indexed_addresses = 1057,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1058,                           /* -mbig */
  OPT_mbig_endian = 1059,                    /* -mbig-endian */
  OPT_mbionic = 1060,                        /* -mbionic */
  OPT_mbit_align = 1061,                     /* -mbit-align */
  OPT_mbit_word = 1062,                      /* -mbit-word */
  OPT_mblock_move_inline_limit_ = 1063,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1064,                       /* -mbss-plt */
  OPT_mcall_ = 1065,                         /* -mcall- */
  OPT_mcmpb = 1066,                          /* -mcmpb */
  OPT_mcpu_ = 1067,                          /* -mcpu= */
  OPT_mdebug_ = 1068,                        /* -mdebug= */
  OPT_mdlmzb = 1069,                         /* -mdlmzb */
  OPT_mdouble_float = 1070,                  /* -mdouble-float */
  OPT_meabi = 1071,                          /* -meabi */
  OPT_memb = 1072,                           /* -memb */
  OPT_mfloat_gprs_ = 1073,                   /* -mfloat-gprs= */
  OPT_mfp_in_toc = 1074,                     /* -mfp-in-toc */
  OPT_mfprnd = 1075,                         /* -mfprnd */
  OPT_mfpu_ = 1076,                          /* -mfpu= */
  OPT_mfriz = 1077,                          /* -mfriz */
  OPT_mfull_toc = 1078,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1079, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1080,            /* -mgen-cell-microcode */
  OPT_mglibc = 1081,                         /* -mglibc */
  OPT_mhard_dfp = 1082,                      /* -mhard-dfp */
  OPT_mhard_float = 1083,                    /* -mhard-float */
  OPT_minsert_sched_nops_ = 1084,            /* -minsert-sched-nops= */
  OPT_misel = 1085,                          /* -misel */
  /* OPT_misel_no = 1086, */                 /* -misel=no */
  /* OPT_misel_yes = 1087, */                /* -misel=yes */
  OPT_mlittle = 1088,                        /* -mlittle */
  OPT_mlittle_endian = 1089,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1090,                  /* -mlong-double- */
  OPT_mlongcall = 1091,                      /* -mlongcall */
  OPT_mmfcrf = 1092,                         /* -mmfcrf */
  OPT_mmfpgpr = 1093,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1094,                   /* -mminimal-toc */
  OPT_mmulhw = 1095,                         /* -mmulhw */
  OPT_mmultiple = 1096,                      /* -mmultiple */
  OPT_mmvme = 1097,                          /* -mmvme */
  OPT_mnewlib = 1098,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1099,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1100,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1101,                        /* -mno-toc */
  OPT_mno_traceback = 1102,                  /* -mno-traceback */
  OPT_mno_update = 1103,                     /* -mno-update */
  OPT_mpaired = 1104,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1105,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1106,                       /* -mpopcntb */
  OPT_mpopcntd = 1107,                       /* -mpopcntd */
  /* OPT_mpowerpc = 1108, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1109,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1110,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1111,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1112,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1113,                     /* -mprototype */
  OPT_mrecip = 1114,                         /* -mrecip */
  OPT_mrecip_precision = 1115,               /* -mrecip-precision */
  OPT_mrecip_ = 1116,                        /* -mrecip= */
  OPT_mregnames = 1117,                      /* -mregnames */
  OPT_mrelocatable = 1118,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1119,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1120,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1121,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1122,                  /* -msched-epilog */
  OPT_msched_groups = 1123,                  /* -msched-groups */
  OPT_msched_prolog = 1124,                  /* -msched-prolog */
  OPT_msdata = 1125,                         /* -msdata */
  OPT_msdata_ = 1126,                        /* -msdata= */
  OPT_msecure_plt = 1127,                    /* -msecure-plt */
  OPT_mshlib = 1128,                         /* -mshlib */
  OPT_msim = 1129,                           /* -msim */
  OPT_msimple_fpu = 1130,                    /* -msimple-fpu */
  OPT_msingle_float = 1131,                  /* -msingle-float */
  OPT_msingle_pic_base = 1132,               /* -msingle-pic-base */
  OPT_msoft_float = 1133,                    /* -msoft-float */
  OPT_mspe = 1134,                           /* -mspe */
  /* OPT_mspe_no = 1135, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1136, */                 /* -mspe=yes */
  OPT_mstrict_align = 1137,                  /* -mstrict-align */
  OPT_mstring = 1138,                        /* -mstring */
  OPT_msum_in_toc = 1139,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1140,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1141,                   /* -mtls-markers */
  OPT_mtls_size_ = 1142,                     /* -mtls-size= */
  OPT_mtoc = 1143,                           /* -mtoc */
  OPT_mtraceback_ = 1144,                    /* -mtraceback= */
  OPT_mtune_ = 1145,                         /* -mtune= */
  OPT_muclibc = 1146,                        /* -muclibc */
  OPT_mupdate = 1147,                        /* -mupdate */
  OPT_mveclibabi_ = 1148,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1149,            /* -mvectorize-builtins */
  OPT_mvrsave = 1150,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1151, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1152, */              /* -mvrsave=yes */
  OPT_mvsx = 1153,                           /* -mvsx */
  OPT_mvsx_align_128 = 1154,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1155,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_memory = 1156,             /* -mvsx-scalar-memory */
  OPT_mwarn_altivec_long = 1157,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1158,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1159,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1160,                     /* -mxl-compat */
  OPT_myellowknife = 1161,                   /* -myellowknife */
  OPT_n = 1162,                              /* -n */
  ...
  OPT_static_libstdc__ = 1211,               /* -static-libstdc++ */
  OPT_static_libtsan = 1212,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1213, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1214, */                /* -std=c++0x */
  OPT_std_c__11 = 1215,                      /* -std=c++11 */
  OPT_std_c__1y = 1216,                      /* -std=c++1y */
  OPT_std_c__98 = 1217,                      /* -std=c++98 */
  OPT_std_c11 = 1218,                        /* -std=c11 */
  /* OPT_std_c1x = 1219, */                  /* -std=c1x */
  /* OPT_std_c89 = 1220, */                  /* -std=c89 */
  OPT_std_c90 = 1221,                        /* -std=c90 */
  OPT_std_c99 = 1222,                        /* -std=c99 */
  /* OPT_std_c9x = 1223, */                  /* -std=c9x */
  OPT_std_f2003 = 1224,                      /* -std=f2003 */
  OPT_std_f2008 = 1225,                      /* -std=f2008 */
  OPT_std_f2008ts = 1226,                    /* -std=f2008ts */
  OPT_std_f95 = 1227,                        /* -std=f95 */
  OPT_std_gnu = 1228,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1229, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1230, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1231,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1232,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1233,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1234,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1235, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1236, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1237,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1238,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1239, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1240, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1241,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1242, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1243, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1244, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1245,                     /* -std=legacy */
  OPT_symbolic = 1246,                       /* -symbolic */
  OPT_t = 1247,                              /* -t */
  OPT_time = 1248,                           /* -time */
  OPT_time_ = 1249,                          /* -time= */
  OPT_tno_android_cc = 1250,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1251,                 /* -tno-android-ld */
